...
function generatePassword() {
  ...
  var confirmUppercase = window.confirm("Confirm uppercase characters on your password?");
  console.log(confirmUppercase);
  if (confirmUppercase === true) {
    characterBank = characterBank + uppercase;
  }

  var confirmLowercase = window.confirm("Confirm lowercase characters on your password?");
  if (confirmLowercase === true) {
    characterBank = characterBank + lowercase;
  }

  var confirmNumbers = window.confirm("Confirm numbers on your password?");
  if (confirmNumbers === true) {
    characterBank = characterBank + numbers;
  }

  var confirmSpecial = window.confirm("Confirm special charaters on your password?");
  ...
  while (!confirmLowercase && !confirmNumbers && !confirmSpecial && !confirmUppercase) {
    ...
    var characterBank = "";
    var confirmUppercase = window.confirm("Confirm uppercase characters on your passowrd?");
    console.log(confirmUppercase);
    if (confirmUppercase === true) {
      characterBank = characterBank + uppercase;
    }
    ...
    var confirmSpecial = window.confirm("Confirm special characters on your password?");
    if (confirmSpecial === true) {
      characterBank = characterBank + special;
    }
  }
